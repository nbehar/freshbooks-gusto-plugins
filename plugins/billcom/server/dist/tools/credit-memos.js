 ...
 * List credit memos
 */
export const listCreditMemos = {
    name: "list_credit_memos",
    description: "List credit memos with filtering, sorting, and pagination. Credit memos are used to credit customers for returns or adjustments.",
    inputSchema: {
        type: "object",
        properties: {
            limit: {
                type: "number",
                description: "Maximum number of credit memos to return per page (default: 50, max: 100)",
                default: 50,
            },
            page: {
                type: "string",
...
export const createCreditMemo = {
    ...
    handler: async (args, client) => {
        try {
            const { customerId, creditMemoDate, referenceNumber, creditMemoLineItems, description, } = args;
            const parsedLineItems = typeof creditMemoLineItems === "string"
 ...
 * Archive credit memo
 */
export const archiveCreditMemo = {
 ...
 * Restore credit memo
 */
export const restoreCreditMemo = {
...
//# sourceMappingURL=credit-memos.js.map