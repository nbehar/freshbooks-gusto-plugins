 ...
 */
export const listReceivablePayments = {
    name: "list_receivable_payments",
    description: "List payments received from customers with filtering, sorting, and pagination. Returns newest first by default.",
    inputSchema: {
        type: "object",
        properties: {
            limit: {
            ...
            sort: {
                type: "string",
                description: "Sort order in 'field:direction' format. Default: 'createdTime:desc'.",
            },
            customerId: {
                type: "string",
    ...
    handler: async (args, client) => {
        const { limit, page, sort, customerId, status, createdAfter, createdBefore } = args;
        try {
            const filters = [];
            if (customerId)
 ...
 */
export const getReceivablePayment = {
...
export const chargeCustomer = {
    ...
    description: "Charge a customer's bank account for one or more invoices. Requires full API access (not available with sync token). The customer must be authorized to charge (use set_customer_charge_authorization) and have a bank account on file (use create_customer_bank_account).",
    inputSchema: {
        type: "object",
        properties: {
            customerId: {
    ...
    handler: async (args, client) => {
        try {
            ...
            const parsedInvoicePayments = typeof invoicePayments === "string"
...
//# sourceMappingURL=receivable-payments.js.map