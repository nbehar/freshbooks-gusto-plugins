...
export const listBankAccounts = {
    ...
    description: "List bank accounts in the Bill.com account with pagination. Returns newest first by default.",
    inputSchema: {
        type: "object",
        properties: {
            limit: {
                type: "number",
                description: "Maximum number of bank accounts to return per page (default: 50, max: 100)",
                default: 50,
            },
            page: {
                type: "string",
