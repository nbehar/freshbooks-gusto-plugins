...
import { buildFilterString, buildListParams, } from "./list-params.js";
describe("buildFilterString", () => {
    ...
    it("should join multiple clauses with commas", () => {
        ...
        expect(buildFilterString(clauses)).toBe('vendorId:eq:"v123",paymentStatus:eq:"open",createdTime:gte:"2025-01-01"');
    });
    it("should handle date-time values with quotes", () => {
        ...
        expect(buildFilterString(clauses)).toBe('createdTime:gte:"2025-01-01T00:00:00.000Z"');
    });
});
...
//# sourceMappingURL=list-params.test.js.map