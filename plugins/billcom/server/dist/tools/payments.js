...
export const listPayments = {
    name: "list_payments",
    description: "List payments with filtering, sorting, and pagination. Returns newest first by default.",
    inputSchema: {
        type: "object",
        properties: {
            limit: {
                type: "number",
                description: "Maximum number of payments to return per page (default: 50, max: 100)",
                default: 50,
            },
            page: {
                type: "string",
            ...
            sort: {
                type: "string",
                description: "Sort order in 'field:direction' format. Sortable fields: processDate, amount, createdTime, updatedTime, description, disbursementStatus. Default: 'createdTime:desc'. Example: 'processDate:desc'",
            },
            status: {
                type: "string",
            ...
            createdAfter: {
                type: "string",
                description: "Filter payments created on or after this date (ISO 8601 format, e.g. 2025-01-01)",
            },
            createdBefore: {
                type: "string",
                description: "Filter payments created on or before this date (ISO 8601 format, e.g. 2025-12-31)",
            },
            processDateAfter: {
                type: "string",
                description: "Filter payments processed on or after this date (ISO 8601 format)",
            },
            processDateBefore: {
                type: "string",
                description: "Filter payments processed on or before this date (ISO 8601 format)",
            },
        },
        required: [],
    },
    handler: async (args, client) => {
        const { limit, page, sort, status, vendorId, createdAfter, createdBefore, processDateAfter, processDateBefore, } = args;
        try {
            const filters = [];
            if (status)
...
export const createPayment = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            fundingAccountId: {
                type: "string",
                description: "The bank account ID to fund the payment from. Use list_bank_accounts to find available accounts.",
            },
            fundingAccountType: {
                type: "string",
    ...
    handler: async (args, client) => {
        try {
            const { fundingAccountId, fundingAccountType, createBill, requestPayFaster, ...rest } = args;
            const body = {
                ...rest,
                fundingAccount: {
...
export const voidPayment = {
    name: "void_payment",
    description: "Void a payment that has already started processing and cannot be canceled. Requires full API access (not available with sync token).",
    inputSchema: {
        type: "object",
        properties: {
            id: {
 ...
 */
export const getVendorPaymentOptions = {
    name: "get_vendor_payment_options",
    description: "Get available payment options for a vendor including payment methods, delivery options, and processing times.",
    inputSchema: {
        type: "object",
        properties: {
            vendorId: {
