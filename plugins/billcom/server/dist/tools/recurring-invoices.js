 ...
 */
export const listRecurringInvoices = {
    name: "list_recurring_invoices",
    description: "List recurring invoices with pagination. Recurring invoices are templates for automatically generating invoices on a schedule.",
    inputSchema: {
        type: "object",
        properties: {
            limit: {
                type: "number",
                description: "Maximum number of recurring invoices to return per page (default: 50, max: 100)",
                default: 50,
            },
        },
        required: [],
 ...
 */
export const getRecurringInvoice = {
...
export const createRecurringInvoice = {
    ...
    handler: async (args, client) => {
        try {
            const { customerId, timePeriod, frequencyPerTimePeriod, nextDueDate, daysInAdvance, recurringInvoiceLineItems, description, } = args;
            const parsedLineItems = typeof recurringInvoiceLineItems === "string"
