...
export const listUserRoles = {
    ...
    description: "List available user roles in the Bill.com organization. Use the returned role IDs when creating or updating users.",
    inputSchema: {
        type: "object",
        properties: {},
        required: [],
...
export const listUsers = {
    name: "list_users",
    description: "List users in the Bill.com organization with pagination.",
    inputSchema: {
        type: "object",
        properties: {
            limit: {
...
export const createUser = {
    name: "create_user",
    description: "Create a new user in the Bill.com organization. Requires full API access (not available with sync token). Use list_user_roles to get available role IDs.",
    inputSchema: {
        type: "object",
        properties: {
            email: {
...
export const updateUser = {
    name: "update_user",
    description: "Update an existing user. Requires full API access (not available with sync token). Use list_user_roles to get available role IDs.",
    inputSchema: {
        type: "object",
        properties: {
            id: {
...
export const deleteUser = {
    name: "delete_user",
    description: "Delete a user from the organization. Requires full API access (not available with sync token).",
    inputSchema: {
        type: "object",
        properties: {
            id: {
